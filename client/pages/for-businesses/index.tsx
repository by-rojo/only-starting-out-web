...
import ForBusinessPage from '../../components/for-business-page'

const ForBusinesses: NextPage<BlogsPageStaticData> = ({ menu }) => {
  return (
    <StaticPageContext data={{ menu }}>
      <>
        <AppHead
          title={`For Businesses – ${process.env.NEXT_PUBLIC_SITE_NAME}`}
